...
import 'package:salesforce/widgets/ui_elements/navigation/bottom_navigation_bar.dart';
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(300),
              border: Border.all(
                color: Theme.of(context).secondaryHeaderColor.withOpacity(.16),
                width: 4,
              ),
            ),
        ...
        children: [
          ...
          ScopedModelDescendant(
            builder: (context, child, MainModel model) {
              return _buildPhoneInputField(context, countries: model.countries);
            },
          ),
          const SizedBox(height: 10),

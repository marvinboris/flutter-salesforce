...
class ClientsAppointmentPage extends StatelessWidget {
  ...
  Widget _buildTimeTracking(
    ...
    final List<Stop> stops = [
      Stop(
        location: 'Rue alfred Saker , 25 Ave...',
        reason: 'Trafic Jam',
        startTime: DateTime(2023, 9, 12, 14, 9, 12),
        endTime: DateTime(2023, 9, 12, 15, 24, 56),
      ),
      Stop(
        location: 'Douala, CM, Bonanjo Avenue n...',
        reason: 'Family reasons',
        startTime: DateTime(2023, 9, 12, 16, 29, 34),
        endTime: DateTime(2023, 9, 12, 16, 56, 23),
      ),
    ];
